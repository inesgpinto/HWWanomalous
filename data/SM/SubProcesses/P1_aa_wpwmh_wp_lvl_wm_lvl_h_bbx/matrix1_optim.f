...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL FFV3_3(W(1,5),W(1,6),GC_125,MDL_MW, FK_MDL_WW,W(1,7)) ! count 28
      CALL OXXXXX(P(0,5),ZERO,-1,+1*IC(5),W(1,8)) ! count 1
      CALL IXXXXX(P(0,6),ZERO,+1,-1*IC(6),W(1,9)) ! count 1
      CALL FFV3_3(W(1,9),W(1,8),GC_125,MDL_MW, FK_MDL_WW,W(1,10)) ! count 28
      ...
      CALL FFS2_3(W(1,13),W(1,11),GC_451,MDL_MH, FK_MDL_WH,W(1,15)) ! count 18
      CALL FFS2_3(W(1,13),W(1,12),GC_451,MDL_MH, FK_MDL_WH,W(1,16)) ! count 18
      CALL FFS2_3(W(1,14),W(1,11),GC_451,MDL_MH, FK_MDL_WH,W(1,17)) ! count 18
      CALL FFS2_3(W(1,14),W(1,12),GC_451,MDL_MH, FK_MDL_WH,W(1,18)) ! count 18
      CALL VVV5_2(W(1,1),W(1,7),GC_3,MDL_MW, ZERO,W(1,19)) ! count 16
      CALL VVV5_2(W(1,2),W(1,7),GC_3,MDL_MW, ZERO,W(1,20)) ! count 16
      CALL VVV5_3(W(1,3),W(1,10),GC_3,MDL_MW, ZERO,W(1,21)) ! count 16
      CALL VVV5_3(W(1,4),W(1,10),GC_3,MDL_MW, ZERO,W(1,22)) ! count 16
      CALL VVS3P1N_3(W(1,21), W(1,19), GC_283, TMP(1))
      call CombineAmpS(4, 
     &(/15,13,16,14/), 
     & (/15,16,17,18/), 
     & TMP, W, AMP(1,1))
      CALL VVS3P1N_3(W(1,21), W(1,20), GC_283, TMP(1))
      call CombineAmpS(4, 
     &(/7,5,8,6/), 
     & (/15,16,17,18/), 
     & TMP, W, AMP(1,1))
      CALL VVS3P1N_3(W(1,22), W(1,19), GC_283, TMP(1))
      call CombineAmpS(4, 
     &(/11,9,12,10/), 
     & (/15,16,17,18/), 
     & TMP, W, AMP(1,1))
      CALL VVS3P1N_3(W(1,22), W(1,20), GC_283, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/15,16,17,18/), 
     & TMP, W, AMP(1,1)) ! count 1
      CALL VVS3_2(W(1,10),W(1,15),GC_283,MDL_MW, FK_MDL_WW,W(1,23)) ! count 8
      CALL VVS3_2(W(1,10),W(1,16),GC_283,MDL_MW, FK_MDL_WW,W(1,24)) ! count 8
      CALL VVS3_2(W(1,10),W(1,17),GC_283,MDL_MW, FK_MDL_WW,W(1,25)) ! count 8
      CALL VVS3_2(W(1,10),W(1,18),GC_283,MDL_MW, FK_MDL_WW,W(1,26)) ! count 8
      CALL VVV5P1N_2(W(1,3), W(1,19), GC_3, TMP(1))
      call CombineAmp(4,
     & (/15,13,16,14/), 
     & (/23,24,25,26/),
     & TMP, W, AMP(1,2))
      CALL VVV5P1N_2(W(1,3), W(1,20), GC_3, TMP(1))
      call CombineAmp(4,
     & (/7,5,8,6/), 
     & (/23,24,25,26/),
     & TMP, W, AMP(1,2))
      CALL VVV5P1N_2(W(1,4), W(1,19), GC_3, TMP(1))
      call CombineAmp(4,
     & (/11,9,12,10/), 
     & (/23,24,25,26/),
     & TMP, W, AMP(1,2))
      CALL VVV5P1N_2(W(1,4), W(1,20), GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/23,24,25,26/),
     & TMP, W, AMP(1,2)) ! count 1
      CALL VVV5_3(W(1,1),W(1,10),GC_3,MDL_MW, ZERO,W(1,27)) ! count 16
      CALL VVV5_3(W(1,2),W(1,10),GC_3,MDL_MW, ZERO,W(1,28)) ! count 16
      CALL VVV5_2(W(1,3),W(1,7),GC_3,MDL_MW, ZERO,W(1,29)) ! count 16
      CALL VVV5_2(W(1,4),W(1,7),GC_3,MDL_MW, ZERO,W(1,30)) ! count 16
      CALL VVS3P1N_3(W(1,27), W(1,29), GC_283, TMP(1))
      call CombineAmpS(4, 
     &(/15,13,16,14/), 
     & (/15,16,17,18/), 
     & TMP, W, AMP(1,3))
      CALL VVS3P1N_3(W(1,27), W(1,30), GC_283, TMP(1))
      call CombineAmpS(4, 
     &(/11,9,12,10/), 
     & (/15,16,17,18/), 
     & TMP, W, AMP(1,3))
      CALL VVS3P1N_3(W(1,28), W(1,29), GC_283, TMP(1))
      call CombineAmpS(4, 
     &(/7,5,8,6/), 
     & (/15,16,17,18/), 
     & TMP, W, AMP(1,3))
      CALL VVS3P1N_3(W(1,28), W(1,30), GC_283, TMP(1))
      call CombineAmpS(4, 
     &(/3,1,4,2/), 
     & (/15,16,17,18/), 
     & TMP, W, AMP(1,3)) ! count 1
      CALL VVS3_1(W(1,7),W(1,15),GC_283,MDL_MW, FK_MDL_WW,W(1,31)) ! count 8
      CALL VVS3_1(W(1,7),W(1,16),GC_283,MDL_MW, FK_MDL_WW,W(1,32)) ! count 8
      CALL VVS3_1(W(1,7),W(1,17),GC_283,MDL_MW, FK_MDL_WW,W(1,33)) ! count 8
      CALL VVS3_1(W(1,7),W(1,18),GC_283,MDL_MW, FK_MDL_WW,W(1,34)) ! count 8
      CALL VVV5P1N_3(W(1,3), W(1,27), GC_3, TMP(1))
      call CombineAmp(4,
     & (/15,13,16,14/), 
     & (/31,32,33,34/),
     & TMP, W, AMP(1,4))
      CALL VVV5P1N_3(W(1,3), W(1,28), GC_3, TMP(1))
      call CombineAmp(4,
     & (/7,5,8,6/), 
     & (/31,32,33,34/),
     & TMP, W, AMP(1,4))
      CALL VVV5P1N_3(W(1,4), W(1,27), GC_3, TMP(1))
      call CombineAmp(4,
     & (/11,9,12,10/), 
     & (/31,32,33,34/),
     & TMP, W, AMP(1,4))
      CALL VVV5P1N_3(W(1,4), W(1,28), GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/31,32,33,34/),
     & TMP, W, AMP(1,4)) ! count 1
      CALL VVV5P1N_2(W(1,1), W(1,29), GC_3, TMP(1))
      call CombineAmp(4,
     & (/15,13,16,14/), 
     & (/23,24,25,26/),
     & TMP, W, AMP(1,5))
      CALL VVV5P1N_2(W(1,1), W(1,30), GC_3, TMP(1))
      call CombineAmp(4,
     & (/11,9,12,10/), 
     & (/23,24,25,26/),
     & TMP, W, AMP(1,5))
      CALL VVV5P1N_2(W(1,2), W(1,29), GC_3, TMP(1))
      call CombineAmp(4,
     & (/7,5,8,6/), 
     & (/23,24,25,26/),
     & TMP, W, AMP(1,5))
      CALL VVV5P1N_2(W(1,2), W(1,30), GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/23,24,25,26/),
     & TMP, W, AMP(1,5)) ! count 1
      CALL VVV5P1N_3(W(1,1), W(1,21), GC_3, TMP(1))
      call CombineAmp(4,
     & (/15,13,16,14/), 
     & (/31,32,33,34/),
     & TMP, W, AMP(1,6))
      CALL VVV5P1N_3(W(1,1), W(1,22), GC_3, TMP(1))
      call CombineAmp(4,
     & (/11,9,12,10/), 
     & (/31,32,33,34/),
     & TMP, W, AMP(1,6))
      CALL VVV5P1N_3(W(1,2), W(1,21), GC_3, TMP(1))
      call CombineAmp(4,
     & (/7,5,8,6/), 
     & (/31,32,33,34/),
     & TMP, W, AMP(1,6))
      CALL VVV5P1N_3(W(1,2), W(1,22), GC_3, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/31,32,33,34/),
     & TMP, W, AMP(1,6)) ! count 1
      CALL VVVV8_3(W(1,1),W(1,3),W(1,7),GC_5,MDL_MW, FK_MDL_WW,W(1,35)) ! count 4
      CALL VVVV8_3(W(1,1),W(1,4),W(1,7),GC_5,MDL_MW, FK_MDL_WW,W(1,36)) ! count 4
      CALL VVVV8_3(W(1,2),W(1,3),W(1,7),GC_5,MDL_MW, FK_MDL_WW,W(1,37)) ! count 4
      CALL VVVV8_3(W(1,2),W(1,4),W(1,7),GC_5,MDL_MW, FK_MDL_WW,W(1,38)) ! count 4
     ...
     & TMP, W, AMP(1,7)) ! count 1
      CALL VVVV8_4(W(1,1),W(1,3),W(1,10),GC_5,MDL_MW, FK_MDL_WW,W(1,39)) ! count 4
      CALL VVVV8_4(W(1,1),W(1,4),W(1,10),GC_5,MDL_MW, FK_MDL_WW,W(1,40)) ! count 4
      CALL VVVV8_4(W(1,2),W(1,3),W(1,10),GC_5,MDL_MW, FK_MDL_WW,W(1,41)) ! count 4
      CALL VVVV8_4(W(1,2),W(1,4),W(1,10),GC_5,MDL_MW, FK_MDL_WW,W(1,42)) ! count 4
