...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WW)
      ...
      CALL VVV5_3(W(1,2),W(1,6),GC_3,MDL_MW, ZERO,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL VVS3_0(W(1,3),W(1,4),W(1,7),GC_283,AMP(1))
      CALL VVS3_2(W(1,6),W(1,7),GC_283,MDL_MW, FK_MDL_WW,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL VVV5_0(W(1,2),W(1,8),W(1,4),GC_3,AMP(2))
      CALL VVV5_3(W(1,1),W(1,6),GC_3,MDL_MW, ZERO,W(1,4))
      CALL VVV5_2(W(1,2),W(1,5),GC_3,MDL_MW, ZERO,W(1,9))
C     Amplitude(s) for diagram number 3
      CALL VVS3_0(W(1,4),W(1,9),W(1,7),GC_283,AMP(3))
      CALL VVS3_1(W(1,5),W(1,7),GC_283,MDL_MW, FK_MDL_WW,W(1,10))
C     Amplitude(s) for diagram number 4
      CALL VVV5_0(W(1,2),W(1,4),W(1,10),GC_3,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL VVV5_0(W(1,1),W(1,8),W(1,9),GC_3,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL VVV5_0(W(1,1),W(1,3),W(1,10),GC_3,AMP(6))
      CALL VVVV8_3(W(1,1),W(1,2),W(1,5),GC_5,MDL_MW, FK_MDL_WW,W(1,10))
C     Amplitude(s) for diagram number 7
      CALL VVS3_0(W(1,6),W(1,10),W(1,7),GC_283,AMP(7))
      CALL VVVV8_4(W(1,1),W(1,2),W(1,6),GC_5,MDL_MW, FK_MDL_WW,W(1,10))
C     Amplitude(s) for diagram number 8
      CALL VVS3_0(W(1,10),W(1,5),W(1,7),GC_283,AMP(8))
