...
C     
      ...
      V1(3)= COUP*(-1D0)*(+CI*(V4(3)*TMP1+V3(3)*TMP2)-2D0 * CI*(V2(3)
     $ *TMP4))
      V1(4)= COUP*(+CI*(V4(4)*TMP1+V3(4)*TMP2)-2D0 * CI*(V2(4)*TMP4))
      V1(5)= COUP*(+CI*(V4(5)*TMP1+V3(5)*TMP2)-2D0 * CI*(V2(5)*TMP4))
      V1(6)= COUP*(+CI*(V4(6)*TMP1+V3(6)*TMP2)-2D0 * CI*(V2(6)*TMP4))
      END
