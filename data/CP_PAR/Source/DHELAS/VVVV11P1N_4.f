...
C     
      ...
      V4(3)= COUP*1D0/2D0*(-2D0 * CI*(V1(3)*TMP1)+CI*(V2(3)*TMP3+V3(3)
     $ *TMP5))
      V4(4)= COUP*(-1D0/2D0)*(-2D0 * CI*(V1(4)*TMP1)+CI*(V2(4)*TMP3
     $ +V3(4)*TMP5))
      V4(5)= COUP*(-1D0/2D0)*(-2D0 * CI*(V1(5)*TMP1)+CI*(V2(5)*TMP3
     $ +V3(5)*TMP5))
      V4(6)= COUP*(-1D0/2D0)*(-2D0 * CI*(V1(6)*TMP1)+CI*(V2(6)*TMP3
     $ +V3(6)*TMP5))
      END
