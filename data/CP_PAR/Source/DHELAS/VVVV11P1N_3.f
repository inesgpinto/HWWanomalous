...
C     
      ...
      V3(3)= COUP*1D0/2D0*(-2D0 * CI*(V2(3)*TMP0)+CI*(V1(3)*TMP2+V4(3)
     $ *TMP5))
      V3(4)= COUP*(-1D0/2D0)*(-2D0 * CI*(V2(4)*TMP0)+CI*(V1(4)*TMP2
     $ +V4(4)*TMP5))
      V3(5)= COUP*(-1D0/2D0)*(-2D0 * CI*(V2(5)*TMP0)+CI*(V1(5)*TMP2
     $ +V4(5)*TMP5))
      V3(6)= COUP*(-1D0/2D0)*(-2D0 * CI*(V2(6)*TMP0)+CI*(V1(6)*TMP2
     $ +V4(6)*TMP5))
      END
