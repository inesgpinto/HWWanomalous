...
C     
      ...
      V1(3)= COUP*(-S5(3))*(+CI*(TMP8*V4(3)+V3(3)*TMP15)-2D0 * CI
     $ *(V2(3)*TMP16))
      V1(4)= COUP*S5(3)*(+CI*(TMP8*V4(4)+V3(4)*TMP15)-2D0 * CI*(V2(4)
     $ *TMP16))
      V1(5)= COUP*S5(3)*(+CI*(TMP8*V4(5)+V3(5)*TMP15)-2D0 * CI*(V2(5)
     $ *TMP16))
      V1(6)= COUP*S5(3)*(+CI*(TMP8*V4(6)+V3(6)*TMP15)-2D0 * CI*(V2(6)
     $ *TMP16))
      END
