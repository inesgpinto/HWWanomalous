...
C     
     ...
     $ * W2))
      V2(3)= DENOM*(OM2*P2(0)*(TMP6*(-CI*(TMP3)+CI*(TMP10))+(+CI*(TMP1
     $ *TMP4)-CI*(TMP5*TMP9)))+(TMP6*(+CI*(P1(0))-CI*(P3(0)))+(V1(3)*(
     $ -CI*(TMP4)+CI*(TMP5))+V3(3)*(-CI*(TMP1)+CI*(TMP9)))))
      V2(4)= DENOM*(OM2*P2(1)*(TMP6*(-CI*(TMP3)+CI*(TMP10))+(+CI*(TMP1
     $ *TMP4)-CI*(TMP5*TMP9)))+(TMP6*(+CI*(P1(1))-CI*(P3(1)))+(V1(4)*(
     $ -CI*(TMP4)+CI*(TMP5))+V3(4)*(-CI*(TMP1)+CI*(TMP9)))))
      V2(5)= DENOM*(OM2*P2(2)*(TMP6*(-CI*(TMP3)+CI*(TMP10))+(+CI*(TMP1
     $ *TMP4)-CI*(TMP5*TMP9)))+(TMP6*(+CI*(P1(2))-CI*(P3(2)))+(V1(5)*(
     $ -CI*(TMP4)+CI*(TMP5))+V3(5)*(-CI*(TMP1)+CI*(TMP9)))))
      V2(6)= DENOM*(OM2*P2(3)*(TMP6*(-CI*(TMP3)+CI*(TMP10))+(+CI*(TMP1
     $ *TMP4)-CI*(TMP5*TMP9)))+(TMP6*(+CI*(P1(3))-CI*(P3(3)))+(V1(6)*(
     $ -CI*(TMP4)+CI*(TMP5))+V3(6)*(-CI*(TMP1)+CI*(TMP9)))))
      END
