...
C     
      ...
      V3(3)= COUP*(TMP2*(-CI*(P1(0))+CI*(P2(0)))+(V1(3)*(+CI*(TMP0)-CI
     $ *(TMP7))+V2(3)*(-CI*(TMP1)+CI*(TMP9))))
      V3(4)= COUP*(TMP2*(+CI*(P1(1))-CI*(P2(1)))+(V1(4)*(-CI*(TMP0)+CI
     $ *(TMP7))+V2(4)*(+CI*(TMP1)-CI*(TMP9))))
      V3(5)= COUP*(TMP2*(+CI*(P1(2))-CI*(P2(2)))+(V1(5)*(-CI*(TMP0)+CI
     $ *(TMP7))+V2(5)*(+CI*(TMP1)-CI*(TMP9))))
      V3(6)= COUP*(TMP2*(+CI*(P1(3))-CI*(P2(3)))+(V1(6)*(-CI*(TMP0)+CI
     $ *(TMP7))+V2(6)*(+CI*(TMP1)-CI*(TMP9))))
      END
